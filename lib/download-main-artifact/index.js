...
const CIRCLECI_BABEL_MAIN_BRANCH_API = `${CIRCLECI_BABEL_API}/tree/main`;
 ...
 */
async function main() {
    console.log(`Calling CircleCI API: ${CIRCLECI_BABEL_MAIN_BRANCH_API}`);
    const builds = await getJSONData(CIRCLECI_BABEL_MAIN_BRANCH_API);
