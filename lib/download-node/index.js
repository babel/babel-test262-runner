...
if ((process.platform !== "linux" && process.platform !== "darwin" && process.platform !== "win32") || require("os").arch() !== "x64") {
  throw new Error("Only 64-bit linux, darwin and windows are supported.");
}

const isWin = process.platform === "win32";

const NODE_NAME = isWin ? "x64/node.exe" : `node-v0.10.48-${process.platform}-x64`;
